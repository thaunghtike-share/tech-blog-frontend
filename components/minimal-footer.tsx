  ...
  return (
    <footer className="bg-white/95 dark:bg-[#0A0A0A] py-16 md:py-20 relative z-10 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10 md:ml-6">
        ...
        <div className="flex">
          {/* Left spacing - matches header ml-8 */}
          <div className="w-8 hidden md:block"></div>
          
          {/* Main content */}
          <div className="flex-1">
            {/* Mobile: 2 rows, 2 columns | Desktop: 6 columns */}
            <div className="grid grid-cols-2 md:grid-cols-6 gap-8 md:gap-12 pb-12">
              {/* Logo + Description - Mobile: Full width, Desktop: 2 columns */}
              ...
              {/* Row 1: Quick Links + Resources - Mobile: 2 columns, Desktop: 2 columns */}
              ...
              {/* Row 2: Services + Contact - Mobile: 2 columns, Desktop: 2 columns */}
              <div className="col-span-1 md:col-span-1">
          ...
          {/* Right spacing - matches header mr-8 */}
          <div className="w-8 hidden md:block"></div>
        </div>
      </div>
    </footer>
