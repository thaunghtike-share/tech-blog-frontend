            ...
            >
              ...
              >
                <div className="p-5 flex-grow">
                  <div className={`w-10 h-10 rounded-lg ${color} flex items-center justify-center mb-3 shadow-md`}>
                    <Icon className="h-5 w-5" />
                  </div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">{title}</h3>
                  <p className="text-gray-700 mb-3 text-sm">{shortDescription}</p>
                ...
                <div className="px-5 pb-5">
                  <div className="flex justify-between items-center">
                    ...
                    <Link
                      href={`/services/${slug}`}
                      className="inline-flex items-center px-3 py-2 bg-gray-900 hover:bg-gray-800 text-white text-sm font-medium rounded-lg transition-colors shadow-md hover:shadow-lg"
                    >
                      Get Started
                    </Link>
                  </div>
