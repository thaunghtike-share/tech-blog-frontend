...
const services = [
  ...
  },
  {
    ...
    details:
      "CI/CD pipeline design, Kubernetes architecture, security hardening, and observability solutions tailored to your needs.",
    icon: Wrench,
  ...
  },
  {
    ...
    details:
      "Full infrastructure ownership including provisioning, CI/CD, monitoring, and deployments as a managed service.",
    icon: CloudCog,
  ...
  return (
    <section className="mt-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-16">
        ...
        <h2 className="text-4xl font-bold text-gray-900 mb-4">Professional DevOps Services</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {services.map(({ title, shortDescription, details, icon: Icon, slug, color }, idx) => {
          ...
          return (
            ...
            >
              <div
                className={`h-full bg-white rounded-xl shadow-lg hover:shadow-xl transition-all overflow-hidden border border-gray-100 flex flex-col ${
                  isExpanded ? "ring-2 ring-blue-500" : ""
                }`}
              >
                <div className="p-6 flex-grow">
                  <div className={`w-12 h-12 rounded-lg ${color} flex items-center justify-center mb-4 shadow-md`}>
                ...
                <div className="px-6 pb-6">
                  <div className="flex justify-between items-center">
                    <button
                      ...
                      className="text-blue-600 hover:text-blue-800 font-medium flex items-center text-sm transition-colors"
                    >
