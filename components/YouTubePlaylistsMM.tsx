  ...
  return (
    ...
    >
      <div className="text-center mb-12">
        ...
        >
          Handpicked Burmese-language video playlists to learn DevOps tools like
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {displayed.map((course, idx) => (
          <motion.div
            ...
            className="group bg-white rounded-xl shadow-lg border-l-4 border-red-500 overflow-hidden transition-all duration-300 hover:shadow-xl" // New: Left border
          >
            {/* Video Container */}
            <div
            ...
            >
              ...
              <div className="absolute top-3 right-3">
                <Badge className="px-3 py-1 bg-white/90 backdrop-blur-sm text-red-700 text-xs font-medium rounded-full shadow-sm border border-gray-200">
                  Burmese
                </Badge>
              </div>
            </div>
            ...
            <div className="p-5">
              ...
              <div className="text-sm text-gray-500 mb-4 flex items-center gap-2">
                <Clock className="w-4 h-4 text-red-500" /> Estimated:{" "}
                {course.duration}
              </div>
              <a
                ...
                className="w-full inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-red-600 to-red-800 text-white font-medium rounded-lg transition-all duration-300 shadow-md hover:shadow-lg hover:scale-[1.01] group/btn" // New button style
              >
