    ...
    <section ref={sectionRef} className="max-w-7xl mx-auto py-12 px-4">
      <div className="mb-5 sm:mb-9 text-center">
        ...
        >
          ...
          <span className="inline-flex items-center px-4 py-1 rounded-full text-sm sm:text-sm font-medium bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-700 border border-blue-200">
        ...
        >
          {displayedCourses.map((course, idx) => (
            <motion.div
              ...
              className="min-w-[23.5rem] sm:min-w-0 group bg-white rounded-xl shadow-lg border-l-4 border-blue-500 overflow-hidden transition-all duration-300 flex flex-col"
            >
