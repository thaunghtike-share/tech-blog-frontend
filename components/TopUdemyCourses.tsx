      ...
      >
        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-8 mb-12">
          <div className="flex-1">
            ...
            <div className="h-1 w-32 bg-gradient-to-r from-sky-500 to-blue-500 rounded-full"></div>
            <p className="text-gray-600 mt-4 text-lg max-w-2xl">
              Curated collection of free online courses designed to help you
              master essential DevOps tools, practices, and methodologies for
    ...
    >
      ...
      {error && (
        <motion.div
          ...
          className="mb-8"
        >
          <div className="bg-gradient-to-r from-yellow-100 to-orange-100 border border-yellow-400 rounded-2xl p-6">
      ...
      {courses.length === 0 ? (
        <div className="text-center py-16">
          <div className="inline-flex items-center justify-center bg-gray-100 rounded-full p-6 mb-6 border border-gray-300">
        ...
        <div className="relative">
          ...
          {canScrollLeft && (
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => scroll("left")}
              className="absolute -left-0 top-25 -translate-y-1/2 z-20 bg-white border-2 border-gray-200 p-3 rounded-full hover:bg-white hover:scale-110 transition-all -ml-6"
          ...
          {canScrollRight && (
            <motion.button
              ...
              className="absolute -right-0 top-25 -translate-y-1/2 z-20 bg-white border-2 border-gray-200 p-3 rounded-full hover:bg-white hover:scale-110 transition-all -mr-6"
                ...
                <div className="block group">
                  <div className="relative">
                    <a
                      ...
                      className="block"
                    >
                      <div className="relative aspect-video bg-gray-200 overflow-hidden rounded-2xl group-hover:scale-105 transition-transform duration-300">
                        {course.cover_image ? (
                          <img
                  ...
                  <div className="mt-4 space-y-2">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full inline-flex items-center justify-center px-4 py-2.5 bg-gradient-to-r from-sky-500 to-blue-600 text-white font-medium rounded-xl transition-all duration-300 hover:scale-[1.02] border border-blue-400/30 mt-3"
                    >
