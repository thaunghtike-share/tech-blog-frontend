      ...
      >
        <div className="text-center mb-6 md:mb-10">
          ...
          <motion.h2
            ...
            className="text-lg md:text-3xl font-bold bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 bg-clip-text text-transparent mb-4"
          >
          ...
          {displayedItems.map(({ title, details, duration }, idx) => {
            return (
              <motion.div
                ...
                className={`flex-shrink-0 w-[70vw] snap-center sm:w-auto relative group h-full bg-white rounded-xl shadow-lg border-l-4 ${currentStageConfig.border} overflow-hidden transition-all duration-300 hover:shadow-xl flex flex-col`} // Added flex flex-col
              >
