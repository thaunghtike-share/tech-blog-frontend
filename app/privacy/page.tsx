      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="max-w-4xl">
            ...
            {/* Last Updated */}
            <div className="inline-flex items-center gap-3 bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-2xl px-6 py-3 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {privacyPrinciples.map((principle, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="bg-gradient-to-br from-white to-slate-50 dark:from-gray-800 dark:to-gray-900 rounded-3xl border border-slate-200 dark:border-gray-700 p-8 shadow-lg hover:shadow-2xl transition-all duration-500 h-full">
                  <div
        ...
        <motion.section
          ...
          className="mb-20"
        >
          <div className="bg-gradient-to-br from-slate-900 to-blue-900 dark:from-slate-800 dark:to-blue-800 rounded-3xl p-12 text-white relative overflow-hidden">
            {/* Background Pattern */}
            ...
            <div className="relative z-10">
              <div className="max-w-4xl">
                ...
                <p className="text-blue-100 dark:text-blue-200 text-lg mb-12 max-w-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {dataCollection.map((section, index) => (
                    <div
                      key={index}
                      className="bg-white/10 dark:bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/20"
                    >
                      ...
                      <ul className="space-y-2">
                        {section.items.map((item, itemIndex) => (
                          <li
                            key={itemIndex}
                            className="flex items-center gap-3 text-blue-100 dark:text-blue-200"
                          >
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4">
                {securityFeatures.map((feature, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-gray-800 border border-slate-200 dark:border-gray-700"
                  >
            ...
            <div className="bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-800 dark:to-blue-900/20 rounded-3xl p-8 border border-slate-200 dark:border-gray-700">
              <div className="text-center">
                ...
                <div className="inline-flex items-center gap-2 bg-white dark:bg-gray-700 border border-slate-300 dark:border-gray-600 rounded-full px-4 py-2 text-slate-700 dark:text-gray-300 text-sm font-medium">
        ...
        >
          <div className="bg-gradient-to-br from-sky-500 to-blue-600 dark:from-sky-600 dark:to-blue-700 rounded-3xl p-12 text-white relative overflow-hidden">
