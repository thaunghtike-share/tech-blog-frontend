...
export default function HundredDaysCloudChallenge() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0A0A0A] relative overflow-hidden transition-colors duration-300">
      ...
      <main className="px-6 md:px-11 md:py-10 pb-8 relative z-10">
        ...
        >
          ...
          <div className="mb-12">
            ...
            <div className="flex flex-col lg:flex-row items-start gap-8 mb-8">
              ...
              <div className="flex-1">
                <h1 className="text-4xl md:text-6xl font-light text-black dark:text-white mb-6 tracking-tight">
                  100 Days of Cloud Challenge
                </h1>
                <p className="text-xl text-black dark:text-gray-300 leading-relaxed max-w-3xl">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 max-w-4xl mx-auto md:py-10">
            {/* Article Count */}
        ...
        <motion.section
          ...
          className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm rounded-3xl border border-slate-200/60 dark:border-gray-700/60 shadow-2xl overflow-hidden"
        >
          <div className="px-4 md:px-8 py-4 md:py-6 border-b border-slate-200/50 dark:border-gray-700/50 bg-gradient-to-r from-white to-slate-50/50 dark:from-gray-800 dark:to-gray-700/50">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 md:gap-4">
              <div>
                ...
                <p className="text-slate-600 dark:text-gray-400 font-medium text-sm md:text-base">
          ...
          {articles.length === 0 ? (
            ...
            <>
                    ...
                    >
                      <div className="flex flex-col lg:flex-row gap-4 md:gap-8 items-start">
                        ...
                        <div className="flex-shrink-0 flex flex-col items-center gap-2 md:gap-4">
                          ...
                          <div className="w-20 h-20 md:w-32 md:h-32 rounded-2xl overflow-hidden border border-slate-200/50 dark:border-gray-600/50 shadow-lg group-hover:shadow-xl transition-all duration-300">
                            <img
                              src={coverImage}
                              alt={`Day ${dayNumber}`}
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-col sm:flex-row flex-wrap items-start sm:items-center gap-2 md:gap-4 mb-2 md:mb-3">
                            <span className="inline-flex items-center gap-1 md:gap-2 text-slate-600 dark:text-gray-400 font-medium text-xs md:text-sm">
                          ...
                          {author && (
                            <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-4">
                              <div className="flex items-center gap-1 md:gap-2 text-slate-700 dark:text-gray-300 font-medium text-xs md:text-sm">
                        ...
                        {/* Read More Button */}
                        <div className="flex items-center w-full lg:w-auto mt-2 md:mt-0">
                          <Link
                            href={`/articles/${article.slug}`}
                            className="inline-flex items-center gap-1 md:gap-2 px-4 py-2 md:px-6 md:py-3 bg-gradient-to-r from-sky-600 to-blue-600 text-white rounded-lg md:rounded-xl hover:shadow-lg transition-all duration-300 font-semibold text-sm md:text-base shadow-md hover:scale-105 group/btn w-full lg:w-auto justify-center"
                          >
                            Read Article
              ...
              {/* Pagination Controls */}
              {totalPages > 1 && (
                <div className="px-4 md:px-8 py-4 md:py-6 border-t border-slate-200/50 dark:border-gray-700/50 bg-gradient-to-r from-white to-slate-50/50 dark:from-gray-800 dark:to-gray-700/50">
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-3 md:gap-0">
                    <div className="text-xs md:text-sm text-slate-600 dark:text-gray-400 font-medium">
                    ...
                    <div className="flex items-center gap-1 md:gap-2">
                      <button
                        ...
                        className="flex items-center gap-1 md:gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-lg md:rounded-xl border border-slate-300 dark:border-gray-600 text-xs md:text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed hover:bg-slate-50 dark:hover:bg-gray-700 transition-all duration-300 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-sm hover:shadow-md text-slate-700 dark:text-gray-300"
                      >
