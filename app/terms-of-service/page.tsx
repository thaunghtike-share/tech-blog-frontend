          ...
          <div className="bg-gradient-to-r from-sky-600 to-blue-600 rounded-3xl p-12 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <a
                ...
                className="inline-flex items-center gap-3 bg-white/20 backdrop-blur-sm rounded-2xl px-6 py-3 border border-white/30 hover:bg-white/30 transition-all duration-300"
              >
